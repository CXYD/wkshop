                ...
                <div class="row">
                   ...
                   <div class="col-xs-9 ia">
                     <div class="col-xs-12 ia"> 
                       <input type="text" id="consigneename" name="consigneename"  class="dxld-log" maxlength="50" placeholder="请输入姓名">
                     </div>
                   </div>
                </div>
    		</div>
         ...
         <li class="register-content">
            ...
            <li class="register-content">
                ...
                <div class="row">
                   ...
                   <div class="col-xs-9 ia">
                     <div class="col-xs-12 ia"> 
                     <textarea  id="address" name="address" placeholder="请输入您的详细地址" class="yhtdsia" maxlength="200" onpropertychange="this.style.height = this.scrollHeight + 'px';" oninput="this.style.height = this.scrollHeight + 'px';"></textarea>
...
<script>
    $("button").click(function(){
       var consigneename=  $.trim($('#consigneename').val());
        ...
        var url='${basepath}/front/mine/saveAddress';
        $.ajax({
            type:"post",
            async:true,
            url:url,
             ...
             success:function(result){
              if(result==true){
                  weui.Loading.info("添加成功！");
                  window.location.href="toAddress?name="+${name};
              }else{
                  weui.Loading.error("添加失败！");
                  return false;
              }
          }
        })
