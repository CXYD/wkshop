...
function SmartWizard(target, options) {
    ...
    var _init = function($this) {
        ...
        $($this.buttons.next).click(function() {
            var nextselect =  $("#nextid").attr("class");
            var realname = $("#realname").val();
            var unitname = $("#unitname").val();
            var telephone = $("#telephone").val();
            //success（成功），error（错误），warning（警告），input（输入）。
            if(nextselect=="selected"){
                    ...
                    if (flag) {
                        $.ajax({
                                ...
                                success: function (result) {
                                    if(result=='1'){
                                        $("#previousid").attr("class",'disabled');
                                        $("#nextid").attr("class",'disabled');
                                        $("#previousid").attr("isdone",'0');
                                        $("#nextid").attr("isdone",'0');
                ...
                var uname = username.replace(/\s+/g, "");
                ...
                var url="checkUserNum?num="+checkcode;
