...
(function(root, factory) {
  ...
  return function(el, options) {
    ...
    if (settings.checkIfNativeDate()) {
      ...
      $display = $("<input type='text' style='border:0;background-color: white;' readonly='readonly' class='pikaday__display pikaday__display--native  text-right" + settings.classes + "' placeholder='" + settings.placeholder + "' />");
