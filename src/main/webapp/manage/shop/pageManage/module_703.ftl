<div class="dcr-views ng-scope" ui-view=""><!-- uiView:  -->
    <div ui-view="" class="ng-scope">
        <div class="e701 ng-scope">
            ...
            <div class="e701-edit-wrap">
                ...
                <div class="e701-edit-selection"><p class="e701-edit-selection-title">添加商品</p>

                    <div class="edit-zone">

                        <div ng-if="templates.type==701" class="ng-scope">
