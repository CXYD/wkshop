...
<div class="row">
    <div class="col-sm-6">
        <div class="m-b-30">
            <button id="bt_back" type="button" class="btn btn-success">返回</button>
        </div>
    </div>
</div>
            ...
            <div class="panel-body">
                <form name="manage_form" class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input id="u_id" type="hidden" name="id" value="${user.id}">
                            <input id="g1" name="username" value="${user.username}" type="text" class="form-control"  placeholder="请输入管理员手机号码" maxlength="11">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="g4" name="nickname" value="${user.nickname}" type="text" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="g2" name="password" value="" type="password" class="form-control" minlength="6">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input id="g3" name="password2" value="" type="password" class="form-control" minlength="6">
                        </div>
                    </div>

                    <div class="col-sm-offset-3 col-sm-3">
                        <button id="add_manage" type="button" class="btn btn-block btn--md btn-success">修改</button>
                    </div>
                </form>
            </div> <!-- panel-body -->
        </div> <!-- panel -->
...
<script>
    ...
    $("#add_manage").click(function(){
        ...
        if(!check_name){
            ...
            $.ajax({
                url: "${basepath}/manage/shopManage/editManage",
    ...
    function checkName() {
        ...
        if($.trim($("#g1").val())==""){
            ...
            $.ajax({
                url: "${basepath}/manage/shopManage/getManageNoId",
                data: {"username":username,"id":id},
                async: false,
                success: function (msg) {
                    if(msg=="账号已存在"){
                        check_name=false;
                        $("#g1").after('<font name="font_name" size="2" color="red">账号已存在</font>');
                    }
                },
                error: function () {
                    swal("", "账户添加失败", "error");
    ...
    function checkPass() {
        ...
        if($.trim($("#g2").val())==""){
            ...
            check_pass=false;
        }else if(!(/^[a-zA-Z0-9]{6,40}$/.test(pass))){
