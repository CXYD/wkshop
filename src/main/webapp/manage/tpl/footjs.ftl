...
<script src="${basepath}/static/js/echarts.common.min.js"></script>

<script src="${basepath}/static/js/artTemplate.js"></script>
<script src="${basepath}/static/js/artTemplate-plugin.js"></script>


<!--Morris Chart-->
<#--<script src="${basepath}/static/assets/morris/morris.min.js"></script>-->
<#--<script src="${basepath}/static/assets/morris/raphael.min.js"></script>-->

<!-- sparkline -->
<#--<script src="${basepath}/static/assets/sparkline-chart/jquery.sparkline.min.js" type="text/javascript"></script>-->
<#--<script src="${basepath}/static/assets/sparkline-chart/chart-sparkline.js" type="text/javascript"></script>-->

<!-- sweet alerts -->
<script src="${basepath}/static/assets/sweet-alert/sweet-alert.min.js"></script>
<#--<script src="${basepath}/static/assets/sweet-alert/sweet-alert.init.js"></script>、-->

<#--<script src="${basepath}/static/assets/chartjs/chart.min.js"></script>-->
<#--<script src="${basepath}/static/assets/chartjs/chartjs.init.js"></script> -->


<!-- Examples -->
<#--<script src="${basepath}/static/assets/magnific-popup/magnific-popup.js"></script>-->
<#--<script src="${basepath}/static/assets/jquery-datatables-editable/jquery.dataTables.js"></script>-->
<#--<script src="${basepath}/static/assets/datatables/dataTables.bootstrap.js"></script>-->
<#--<script src="${basepath}/static/assets/jquery-datatables-editable/datatables.editable.init.js"></script>-->


<!--Form Validation-->
<script src="${basepath}/static/assets/form-wizard/bootstrap-validator.min.js" type="text/javascript"></script>

<!--Form Wizard-->
<#--<script src="${basepath}/static/assets/form-wizard/jquery.steps.min.js" type="text/javascript"></script>-->
<script type="text/javascript" src="${ctxStatic}/assets/jquery.validate/jquery.validate.min.js"></script>

<!--wizard initialization-->
<#--<script src="${basepath}/static/assets/form-wizard/wizard-init.js" type="text/javascript"></script>-->



<script src="${basepath}/static/js/jquery.app.js"></script>
<!-- Chat -->
<#--<script src="${basepath}/static/js/jquery.chat.js"></script>-->
<!-- Dashboard -->
<#--<script src="${basepath}/static/js/jquery.dashboard.js"></script>-->

<!-- Todo -->
<#--<script src="${basepath}/static/js/jquery.todo.js"></script>-->

<#--<script src="${basepath}/static/js/main/main.js"></script>-->

<script src="${basepath}/static/js/ajaxfileupload.js"></script>

<script src="${basepath}/static/assets/tagsinput/jquery.tagsinput.min.js"></script>
<script src="${basepath}/static/assets/toggles/toggles.min.js"></script>
<!-- datatables -->
