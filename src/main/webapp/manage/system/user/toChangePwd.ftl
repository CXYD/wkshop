    ...
    <form name="form" action="" method="post">
		<table class="table table-bordered" >
			...
			<tr>
                ...
                <td><input class="col-sm-2.5" style="width: 165px" type="text"    maxlength="11" id="username" name="username" placeholder="请填写注册手机号码"  value="${username!''}">
                <input class="col-sm-1.5 btn btn-sm btn-warning" type="button"  onclick="sendSMS(this)" value="获取验证码" ></input></td>
			</tr>
			<tr>
			...
			<tr>
				<td  colspan="2" style="text-align: center;">
					<div  onclick="updateChangePwd()" class="btn btn-success">
						<i class="icon-ok icon-white"></i> 修改密码
					</div>
				</td>
			</tr>
		</table>
