...
//创建文件夹
        ...
        try {
            ...
            ImageUtils.ratioZoom(uploadedFile3, uploadedFile1, Double.valueOf(SystemManager.getInstance().getProperty("product_image_1_w")));
            ImageUtils.ratioZoom(uploadedFile3, uploadedFile2, Double.valueOf(SystemManager.getInstance().getProperty("product_image_2_w")));
        } catch (Exception e) {
