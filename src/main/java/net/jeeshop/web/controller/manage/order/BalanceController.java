            ...
            if(LoginUserHolder.getLoginUser()!=null && StringUtils.isNotBlank(LoginUserHolder.getLoginUser().getKhid())){
                ...
                if(baldate!=null && endTime!=null){
                    try {
                        ...
                        criteria.andBaldateGreaterThanOrEqualTo(simpleDateFormat.parse(startd));
                        criteria.andBaldateLessThanOrEqualTo(simpleDateFormat.parse(endd));
